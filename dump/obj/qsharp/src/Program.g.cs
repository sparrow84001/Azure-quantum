...
#line hidden
            {
#line 11 "D:\\azure quantum\\dump\\Program.qs"
                var qubits = Allocate__.Apply(3L);
#line hidden
                bool __arg1__ = true;
                try
                {
#line 12 "D:\\azure quantum\\dump\\Program.qs"
                    Microsoft__Quantum__Canon__ApplyToEach.Apply((Microsoft__Quantum__Intrinsic__H, qubits));
#line 13 "D:\\azure quantum\\dump\\Program.qs"
                    Message__.Apply("The qubit register in a uniform superposition: ");
#line 14 "D:\\azure quantum\\dump\\Program.qs"
                    Microsoft__Quantum__Diagnostics__DumpMachine.Apply(QVoid.Instance);
#line 15 "D:\\azure quantum\\dump\\Program.qs"
                    var results = QArray<Result>.Create(0L);
#line 16 "D:\\azure quantum\\dump\\Program.qs"
                    foreach (var q in qubits)
#line hidden
                    {
#line 17 "D:\\azure quantum\\dump\\Program.qs"
                        Message__.Apply(" ");
#line 18 "D:\\azure quantum\\dump\\Program.qs"
                        results = QArray<Result>.Add(results, new QArray<Result>(Microsoft__Quantum__Intrinsic__M.Apply(q)));
#line 19 "D:\\azure quantum\\dump\\Program.qs"
                        Microsoft__Quantum__Diagnostics__DumpMachine.Apply(QVoid.Instance);
                    }

#line 21 "D:\\azure quantum\\dump\\Program.qs"
                    Message__.Apply(" ");
#line 22 "D:\\azure quantum\\dump\\Program.qs"
                    Message__.Apply("Your random number is: ");
#line 23 "D:\\azure quantum\\dump\\Program.qs"
